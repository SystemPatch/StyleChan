    ...
    $SS = {
        ...
        options: {
            ...
            init: function() {
                ...
                /* When 4chan XT */
                var c = $("<span class='shortcut brackets-wrap' data-index='840'><a class='settings-link' title='StyleChan Settings' href='javascript:;'><span class='icon--alt-text'>StyleChan Settings</span>" + $SS.theme.icons.menuIcon + "</a></span>").bind("click", $SS.options.show);
                $.asap(function() {
        ...
        Theme: function(index) {
            ...
            this.icons = {
                ...
                menuIcon: "<svg viewBox='7 7 20 20' preserveAspectRatio='true' height='14' width='14' xmlns='http://www.w3.org/2000/svg'>" +
                    "<path fill='rgb(" + this.headerLColor.rgb + ")' d='M22.727,18.242L4.792,27.208l8.966-8.966l-4.483-4.484l17.933-8.966l-8.966,8.966L22.727,18.242z'/></svg>",
